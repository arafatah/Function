...
/*
// Immediately invoked function expression (IIFE) - onetime function - Function that use once.
//USAGES: Protect data. Private data collection function. Data privacy.
// Normal function
...
//Arrow IIFE function
(() => console.log('This will also never run again anymore'))();
...
lufthansa.book(239, 'Arafat');
lufthansa.book(174, 'Hung');
console.log(lufthansa);
...
// another way wih function return function
const addTaxRate = function (rate) {
  return function (value) {
    return value + value * rate;
  };
